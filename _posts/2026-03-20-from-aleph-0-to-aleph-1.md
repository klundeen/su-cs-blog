...
![A museum drawer of pinned beetle specimens. Each one is its own fact — unique, incompressible, irreducible to first principles. Understanding how beetles work compresses beautifully. Knowing which beetle this is does not.](/assets/images/beetle-specimens.jpg)
...
![Cantor's diagonal argument: take any proposed list of real numbers, read the diagonal digits, change each one, and you've constructed a number that can't be on the list. The reals are a bigger infinity than the naturals.](/assets/images/cantor-diagonal.svg)
...
![A cholla cactus skeleton — the lattice-within-lattice structure that caught my sister's eye. Each hole is unique, but the pattern of holes is organized, and the pattern of patterns is organized differently still. Multiple orders of random.](/assets/images/cholla-skeleton.jpg)
